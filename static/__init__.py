...
notaconn = psycopg2.connect(host="localhost",user="antopher",password="4S&7Ya", dbname="NOTAmembers")
...
@app.route('/familytreekinship')
def showkinshippdf():
	
	return render_template('familyfamilyfamily.html')
...
@app.route('/weeble')
def weeblegems():
	return render_template('weeble.html')
